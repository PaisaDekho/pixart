      ...
      <div class="row">
        <div class="col-md-12" >
          <div class="card" style="min-height: 700px;">
            <div class="nav-wrapper position-relative end-0 px-2 pt-2 row">
                <div class="col-12 col-sm-2 col-md-2">
                <ul class="nav nav-pills flex-column p-1" role="tablist">
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 active d-flex align-items-center ps-2" data-bs-toggle="tab" role="tab" aria-selected="true" id="edit_profile_lay-tab" aria-controls="edit_profile_lay" href="#edit_profile_lay">
                    <i class="fa fa-pen"></i>
                    <span class="ms-2">AppSetting</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 d-flex align-items-center ps-2" data-bs-toggle="tab" role="tab" aria-selected="false" id="refer_lay-tab" aria-controls="refer_lay" href="#refer_lay">
                    <i class="fa fa-donate"></i>
                    <span class="ms-2">ReferEarn</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 d-flex align-items-center ps-2" data-bs-toggle="tab" role="tab" aria-selected="false" id="payment_lay-tab" aria-controls="payment_lay" href="#payment_lay">
                    <i class="fa fa-credit-card"></i>
                    <span class="ms-2">Payment</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 d-flex align-items-center ps-2" data-bs-toggle="tab" role="tab" aria-selected="false" id="notifiacation_lay-tab" aria-controls="notifiacation_lay" href="#notifiacation_lay">
                    <i class="fa fa-bell"></i>
                    <span class="ms-2">Notification</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 d-flex align-items-center ps-2" data-bs-toggle="tab" role="tab" aria-selected="false" id="Whatsapp_lay-tab" aria-controls="whatsapp_lay" href="#whatsapp_lay">
                    <i class="fa fa-whatsapp"></i>
                    <span class="ms-2">Whatsapp</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 d-flex align-items-center ps-2" data-bs-toggle="tab" role="tab" aria-selected="false" id="ads_lay-tab" aria-controls="ads_lay" href="#ads_lay">
                    <i class="fa fa-ad"></i>
                    <span class="ms-2">Ads</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 d-flex align-items-center ps-2" data-bs-toggle="tab" role="tab" aria-selected="false" id="storage_lay-tab" aria-controls="storage_lay" href="#storage_lay">
                    <i class="fa fa-database"></i>
                    <span class="ms-2">Storage</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 d-flex align-items-center ps-2" data-bs-toggle="tab" role="tab" aria-selected="false" id="app_update_lay-tab" aria-controls="app_update_lay" href="#app_update_lay">
                    <i class="fa fa-mobile-alt"></i>
                    <span class="ms-2">Update</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 d-flex align-items-center ps-2" data-bs-toggle="tab" role="tab" aria-selected="false" id="privacy_terms_lay-tab" aria-controls="privacy_terms_lay" href="#privacy_terms_lay">
                ...
                <div class="tab-content" id="animateLineContent-4">
                    ...
                    <div class="tab-pane fade" id="payment_lay" role="tabpanel" aria-labelledby="payment_lay-tab">
                        ...
                        <div class="row p-2">
                            ...
                            <div class="col-md-12" >
                                <div class="form-check form-switch">
                                  <input class="form-check-input" name="ccavenue" type="checkbox" id="rememberMe" @if(App\Models\Setting::getValue('ccavenue')=='true') checked @endif>
                                  <label class="text-center form-check-label" for="rememberMe">CCAvenue Payment</label>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <label for="text-center" class="form-control-label">Merchant Id</label>
                                <input class="form-control" name="cca_merchant_id" type="text" value="{{App\Models\Setting::getValue('cca_merchant_id')}}">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <label for="text-center" class="form-control-label">Access Code</label>
                                <input class="form-control" name="cca_accessCode" type="text" value="{{App\Models\Setting::getValue('cca_accessCode')}}">
                              </div>
                            </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <label for="text-center" class="form-control-label">QR Image</label>
                                <input class="form-control" id="qrImage" onchange="qrImageChange()" name="qr_image" type="file">
                              </div>
                            </div>
                            
                            
                            <div class="col-md-6" id="previewQrImage">
                              <div class="form-group">
                                <div class='imageCard col-xl-2 col-sm-3 mb-2'>
                                  <div class='avatar avatar-xxl position-relative'>
                                    <img src="{{App\Models\Setting::getValue('qr_image_url')}}" class='border-radius-md' alt='team-2'>
                                  </div>
                                </div>
                              </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="whatsapp_lay" role="tabpanel" aria-labelledby="whatsapp_lay-tab">
                       <form method="post" action="{{ url('setting/whatsapp') }}" enctype="multipart/form-data">
                        ...
                        <div class="row p-2">
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                                <label for="text-center" class="form-control-label">APP Key</label>
                                <input class="form-control" name="whatsapp_app_key" type="text" value="{{App\Models\Setting::getValue('whatsapp_app_key')}}">
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group">
                            ...
                            <div class="col-md-1" >
                                <a href="https://wspsender.com/login" for="text-center" class="btn btn-success ">Get Keys</a>
                            </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <label for="text-center" class="form-control-label">Whatsapp Number</label>
                                <input class="form-control" name="whatsapp_number" type="text" value="{{App\Models\Setting::getValue('whatsapp_number')}}">
                              </div>
                            </div>
                            
                            <div class="col-md-12" >
                                <div class="form-check form-switch text-center">
                                  <input class="form-check-input" name="whatsapp_contact" type="checkbox" id="whatsapp_contact" @if(App\Models\Setting::getValue('whatsapp_contact')=='true') checked @endif>
                                  <label class="text-center form-check-label" for="whatsapp_contact">Whatsapp Contact</label>
                                </div>
                            </div>
...
<script>
    ...
    function qrImageChange(){
        var fileInput = document.getElementById('qrImage');
        if (fileInput.files && fileInput.files[0]) {
            var reader = new FileReader();
            reader.onload = function(e) {
                document.getElementById("previewQrImage").innerHTML = "";
                $('#previewQrImage').append(
                "<div class='imageCard col-xl-2 col-sm-3 mb-2'>"+
                  "<div class='avatar avatar-xxl position-relative'>"+
