                        ...
                        <div class="col-md-6">
                            ...
                            <div class="">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input class="form-control" name="daily_limit" type="number" placeholder="5" required>
                                    </div>
                                    <div class="col-6">
                                        <label for="example-text-input" class="form-control-label">Total Posts Limit</label>
                                        <input class="form-control" name="posts_limit" type="number" placeholder="10" required>
                                    </div>
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            <div class="">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="example-text-input" class="form-control-label">Business Profile Limit</label>
                                        <input class="form-control" name="business_limit" type="number" placeholder="2" required>
                                    </div>
                                    <div class="col-6">
                                        <label for="example-text-input" class="form-control-label">Political Profile Limit</label>
                            ...
                            <div style="margin-left:18px;">
                                <div class="row">
                                    <div class="col-6 form-switch">
                                        <input class="form-check-input" name="festival" type="checkbox" id="festival" checked>
                                        <label class="form-check-label" for="festival">Festival Posts</label>
                                    </div>
                                    <div class="col-6 form-switch">
                                        <input class="form-check-input" name="business" type="checkbox" id="business" checked>
                          ...
                          <div class="form-group">
                            <div style="margin-left:18px;">
                                <div class="row">
                                    <div class="col-6 form-switch">
                                        <input class="form-check-input" name="political" type="checkbox" id="political" checked>
                                        <label class="form-check-label" for="political">Political Posts</label>
                                    </div>
                                    <div class="col-6 form-switch">
                                        <input class="form-check-input" name="video" type="checkbox" id="video" checked>
